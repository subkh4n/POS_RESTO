...
const UsersPage: React.FC<UsersPageProps> = ({ currentUserId }) => {
  ...
  return (
    <TooltipProvider>
      <div className="flex-1 p-6 space-y-6 overflow-auto min-h-screen" style={{ background: 'linear-gradient(135deg, #f8fafc 0%, #ffffff 50%, #eff6ff 100%)' }}>
        {/* Premium Header */}
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl font-black tracking-tight text-gray-900">Manajemen Pengguna</h1>
        ...
        {filteredUsers.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-12 text-center">
            ...
            <p className="text-lg font-bold text-gray-800 mb-1">Tidak ada user ditemukan</p>
            <p className="text-sm text-gray-500">Tambahkan user baru untuk memulai</p>
          </div>
        ) : (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
            ...
            >
              <div className="text-xs font-bold text-gray-600 uppercase tracking-wider">User</div>
              <div className="text-xs font-bold text-gray-600 uppercase tracking-wider">Role</div>
              <div className="text-xs font-bold text-gray-600 uppercase tracking-wider hidden md:block">Kontak</div>
              <div className="text-xs font-bold text-gray-600 uppercase tracking-wider">Status</div>
              <div className="text-xs font-bold text-gray-600 uppercase tracking-wider text-right pr-2">Aksi</div>
            </div>
        ...
        <Dialog open={showModal} onOpenChange={setShowModal}>
          <DialogContent className="fixed left-[50%] top-4 z-50 w-[95vw] max-w-md translate-x-[-50%] translate-y-0 p-0 border-0 bg-white shadow-2xl duration-200 rounded-2xl max-h-[calc(100vh-2rem)] flex flex-col overflow-hidden">
            {/* Header - Gradient */}
            <div className="flex-none bg-gradient-to-br from-blue-600 via-indigo-600 to-violet-600 p-5 text-white relative overflow-hidden rounded-t-2xl">
               {/* Decorative circles */}
            ...
            <div className="flex-1 overflow-y-auto">
              ...
              {error && (
                <Alert variant="destructive" className="border-red-500/20 bg-red-50 text-red-700 animate-in fade-in zoom-in-95">
              ...
              <div className="grid grid-cols-2 gap-5">
                <div className="space-y-2">
                  <Label htmlFor="username" className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Username</Label>
              ...
              <div className="space-y-2">
                <Label htmlFor="name" className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Nama Lengkap</Label>
                <Input
                  id="name"
                  value={formData.name}
                  onChange={(e) =>
              ...
              <div className="space-y-2">
                <Label htmlFor="role" className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Role & Akses</Label>
                <div className="relative">
                  ...
                  >
                    ...
                    <SelectContent>
                      <SelectItem value="KASIR">Kasir (Transaksi POS)</SelectItem>
                      <SelectItem value="MANAGER">Manager (Laporan & Stok)</SelectItem>
                      <SelectItem value="ADMIN">Administrator (Full Akses)</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
              </div>
              ...
              <div className="grid grid-cols-2 gap-5">
                ...
                <div className="space-y-2">
                  <Label htmlFor="phone" className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Telepon</Label>
                  <Input
                    id="phone"
                    type="tel"
              ...
              <div className="flex items-center justify-between p-4 bg-gray-50 rounded-xl border border-gray-100 mt-2">
                <div className="grid gap-0.5">
                   <Label htmlFor="isActive" className="text-sm font-semibold text-gray-700">Status Akun</Label>
                   <p className="text-xs text-gray-500">Aktifkan agar user dapat login</p>
                </div>
                <Switch
                  id="isActive"
              ...
              <DialogFooter className="pt-2 gap-2 sticky bottom-0 bg-white p-4 border-t border-gray-100 -mx-6 -mb-6 mt-4">
                <DialogClose asChild>
                  <Button type="button" variant="outline" className="rounded-xl border-gray-200 hover:bg-gray-50 hover:text-gray-900">
                    Batal
                  </Button>
                </DialogClose>
                <Button type="submit" disabled={isSubmitting} className="rounded-xl bg-blue-600 hover:bg-blue-700 text-white shadow-lg shadow-blue-600/20">
                  {isSubmitting ? (
                    <>
